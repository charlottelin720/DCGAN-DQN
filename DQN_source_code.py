...
Original file is located at
    https://colab.research.google.com/drive/17VhEZ1PNDGYDxia4IY4zPX4AIm21H08h
    ...
    for i_episode in range(num_episodes):
        ...
        for _ in range(10000):
            ...
            if done:
                ...
                episode_reward_train.append(episode_reward)
                np.save('episode_reward_train.npy', episode_reward_train)
        ...
        if i_episode % args.eval_per_ep == 0:
            ...
            episode_reward_test.append(average_reward)
            np.save('episode_reward_test.npy', episode_reward_test)
            print(eval_info_str)
            log_fd.write(eval_info_str)
    
    log_fd.close()
    # np.save('episode_reward_test_all.npy', episode_reward_test)
    # np.save('episode_reward_train_all.npy', episode_reward_train)
    return episode_reward_train, episode_reward_test
...
episode_reward_train_get, episode_reward_test_get = train()

# np.save('episode_reward_test_total.npy', episode_reward_test)
# np.save('episode_reward_train_total.npy', episode_reward_train)

import numpy as np
episode_reward_train_save=np.load('episode_reward_train.npy')
# print(loadedList1.tolist())
episode_reward_test_save=np.load('episode_reward_test.npy')
# print(loadedList2.tolist())

fig, ax = plt.subplots(1, 2)
fig.set_size_inches(12, 4)
ax[0].set_title('episode reward in learning time')
ax[0].set_xlabel('episode')
ax[0].set_ylabel('episode reward')
ax[0].plot(episode_reward_train_save)

ax[1].set_title('episode reward in evaluation time')
ax[1].set_xlabel('episode')
ax[1].set_ylabel('episode reward')
ax[1].plot(episode_reward_test_save)
# plt.legend(loc=1)
...
ax[0].set_xlabel('episode')
ax[0].set_ylabel('episode reward')
ax[0].plot(episode_reward_train_get)

ax[1].set_title('episode reward in evaluation time')
ax[1].set_xlabel('episode')
ax[1].set_ylabel('episode reward')
ax[1].plot(episode_reward_test_get)
# plt.legend(loc=1)
...
# ax[0].set_xlabel('episode')
# ax[0].set_ylabel('episode reward')
# ax[0].plot(episode_reward_train)

# ax[1].set_title('episode reward', color='r')
# ax[1].set_xlabel('episode')
# ax[1].set_ylabel('episode reward')
# ax[1].plot(episode_reward_train, label = 'learning time')
# ax[1].plot(episode_reward_test, label = 'evaluation time')
# plt.legend(loc=1)
...
#                         %(s+1, q_value[0,0], q_value[0,1], q_value[0,2], np.average(q_value), action.item()) )
            ...
            fig = plt.gcf()
            plt.savefig(os.path.join('./shot/step_'+ name + '.jpg'),
                          bbox_inches='tight',
                          transparent=True,
                          pad_inches=0.1) 
